...
export const Button = ({ _variant, children, ...props }: ButtonProps) => {
  return (
    <button
      {...props}
      className={`w-full h-[50px] align-middle flex items-center justify-center rounded-lg uppercase font-[600] text-2xl md:text-3xl border border-gray bg-grayBlank text-gray ${
        _variant === "meal"
